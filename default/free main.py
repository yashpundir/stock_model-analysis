...
my_channel = client.loop.run_until_complete(getentity())
...
df_recent.insert(0, 'What', df_recent['Type'].str[:-8])
...
backup.to_excel('D:/Yash/Python Projects/tgm_stk_tkr/default/data/free channel/backup data.xlsx', index=False)
...
df_result = pd.read_excel('D:/Yash/Python Projects/tgm_stk_tkr/default/data/free channel/Result.xlsx') 
...
df_updated_results.to_excel('D:/Yash/Python Projects/tgm_stk_tkr/default/data/free channel/Result.xlsx', index=False)
...
with open('D:/Yash/Python Projects/tgm_stk_tkr/default/last_id.py', 'w') as file:
    file.write(f"free_last_id = {last_id}\npaid_last_id = {paid_last_id}\nlast_updated = '{today}'")
